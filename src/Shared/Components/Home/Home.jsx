            ...
            <section className="flex flex-col gap-4 max-w-[90rem] md:px-5 px-3 mx-auto  ">
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-5 grid-cols-1  h-full ">
                <div className="h-full">
                  ...
                  <Link to='/about'>
                    <div className=" border-l-4 border-l-[#18025b] border h-full border-[#18025b] rounded-lg overflow-hidden hover:scale-95 duration-300  relative  flex flex-col justify-between ">
                      ...
                      <div className="bg-[#18025b] w-20 h-20 absolute -top-10 -right-10 rotate-45 flex justify-center items-center ">
                        <FaUnlockAlt className="text-white mt-10 -rotate-45" />
                      </div>
                    </div>
                  </Link>
                ...
                <div className="h-full">
                  ...
                  <Link to='/Peer-Review-Process'>
                    <div className=" border-l-4 border-l-[#18025b]  h-full border border-[#18025b] rounded-lg overflow-hidden   hover:scale-95 duration-300  relative  flex flex-col justify-between ">
                      <div className=" p-4 flex flex-col gap-2">
                      ...
                      <div className="bg-[#18025b] w-20 h-20 absolute -top-10 -right-10 rotate-45 flex justify-center items-center ">
                        <FaUserCheck className="text-white mt-10 -rotate-45" />
                      </div>
                    </div>
                  </Link>
                </div>
                <div className="h-full">
                  ...
                  <Link to='/abstracting-and-indexing'>
                    <div className=" border-l-4 border-l-[#18025b] border h-full border-[#18025b] rounded-lg overflow-hidden  hover:scale-95 duration-300  relative  flex flex-col justify-between ">
                      ...
                      <div className="bg-[#18025b] w-20 h-20 absolute -top-10 -right-10 rotate-45 flex justify-center items-center ">
                        <FaDatabase className="text-white mt-10 -rotate-45" />
                      </div>
                    </div>
                  </Link>
                </div>
