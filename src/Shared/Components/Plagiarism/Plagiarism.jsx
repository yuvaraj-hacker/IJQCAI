                    ...
                    <section className="flex flex-col gap-5">
                        ...
                        <section className="flex flex-col gap-2">
                            ...
                            <div className='flex flex-col gap-2  md:text-base text-sm'>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-ss-dot-circle text-xs text-[#18025b]   flex items-center"></i>
                                    <p  ><span className='text-[#18025b] font-semibold'>Direct Plagiarism:</span> Copying text verbatim without proper citation.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-ss-dot-circle text-xs text-[#18025b]   flex items-center"></i>
                                    <p  ><span className='text-[#18025b] font-semibold'>Self-Plagiarism:</span> Reusing one’s own previously published work without disclosure.</p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-ss-dot-circle text-xs text-[#18025b]   flex items-center"></i>
                                    <p  ><span className='text-[#18025b] font-semibold'>Mosaic Plagiarism:</span> Mixing copied phrases with original text without proper acknowledgment.  </p>
                                </div>
                                <div className='flex items-center gap-2'>
                                    <i className="fi fi-ss-dot-circle text-xs text-[#18025b]   flex items-center"></i>
                                    <p  ><span className='text-[#18025b] font-semibold'>Improper Paraphrasing:</span> Rewording another author’s work without appropriate citation.</p>
                                </div>
