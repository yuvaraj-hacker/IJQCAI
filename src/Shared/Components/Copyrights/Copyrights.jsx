                    ...
                    <section className="flex flex-col gap-5">
                        ...
                        <section className="flex flex-col gap-4">
                            ...
                            <p className="text-justify md:text-base text-sm">
                                I/We ____________________________, the author(s) of the research paper/article entitled ______________________, hereby grant permission for the publication of the above-mentioned paper/article in International Journal of Quantum Computing and AI.
                            </p>
                            <p className="text-justify md:text-base text-sm">
